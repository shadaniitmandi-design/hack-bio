  ...
  return (
    <Link to="/" className="flex items-center gap-3 group">
      <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4 4L28 28M28 4L4 28" stroke="rgb(210 255 62)" strokeWidth="1.6" />
        <circle cx="16" cy="16" r="3.2" stroke="rgb(210 255 62)" strokeWidth="1.6" fill="none" />
        <circle cx="4" cy="16" r="1.6" fill="rgb(210 255 62)" />
        <circle cx="28" cy="16" r="1.6" fill="rgb(210 255 62)" />
        <circle cx="16" cy="4" r="1.6" fill="rgb(210 255 62)" />
        <circle cx="16" cy="28" r="1.6" fill="rgb(210 255 62)" />
      </svg>
